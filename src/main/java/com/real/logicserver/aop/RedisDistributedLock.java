package com.real.logicserver.aop;
...
public class RedisDistributedLock {
    ...
    @Pointcut("execution(* com.real.logicserver.social.friend.service.FriendService.*(..))")
    public void pointCut(){};

    @Pointcut("execution(* com.real.logicserver.price.api.PayApi.*(..))")
    public void payCut(){};

    @Around("payCut()")
    public Object payAround(ProceedingJoinPoint point) throws Throwable{
